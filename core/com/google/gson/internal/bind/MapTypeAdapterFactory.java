  ...
  implements TypeAdapterFactory
{
  ...
  {
    return (keyType == Boolean.TYPE) || (keyType == Boolean.class) ? 
    ...
    extends TypeAdapter<Map<K, V>>
  {
      ...
      throws IOException
    {
      ...
      if (hasComplexKeys)
      {
        ...
        {
          out.beginArray();
          Streams.write((JsonElement)((List)keys).get(i), out);
      ...
      else
      {
        ...
        for (int i = 0; i < ((List)keys).size(); i++)
        {
          JsonElement keyElement = (JsonElement)((List)keys).get(i);
