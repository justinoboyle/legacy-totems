...
public final class TypeAdapters
{
    ...
    extends TypeAdapter<T>
  {
    ...
    public EnumTypeAdapter(Class<T> classOfT)
    {
      ...
      {
        Enum[] arrayOfEnum;
        int j = (arrayOfEnum = (Enum[])classOfT.getEnumConstants()).length;
        for (int i = 0; i < j; i++)
        {
          T constant = arrayOfEnum[i];
  ...
  public static <TT> TypeAdapterFactory newFactory(TypeToken<TT> type, final TypeAdapter<TT> typeAdapter)
  {
    new TypeAdapterFactory()
    {
      public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken)
      {
        return typeToken.equals(TypeAdapters.this) ? typeAdapter : null;
      }
    };
  }
  ...
  public static <TT> TypeAdapterFactory newFactory(Class<TT> type, final TypeAdapter<TT> typeAdapter)
  {
    new TypeAdapterFactory()
    {
      public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken)
      {
        return typeToken.getRawType() == TypeAdapters.this ? typeAdapter : null;
      }
      
      public String toString()
      {
        return "Factory[type=" + TypeAdapters.this.getName() + ",adapter=" + typeAdapter + "]";
      }
    };
  }
  ...
  public static <TT> TypeAdapterFactory newFactory(Class<TT> unboxed, final Class<TT> boxed, final TypeAdapter<? super TT> typeAdapter)
  {
    new TypeAdapterFactory()
    {
      ...
      {
        Class<? super T> rawType = typeToken.getRawType();
        return (rawType == TypeAdapters.this) || (rawType == boxed) ? typeAdapter : null;
      }
      
      public String toString()
      {
        return 
          "Factory[type=" + boxed.getName() + "+" + TypeAdapters.this.getName() + ",adapter=" + typeAdapter + "]";
      }
    };
  }
  ...
  public static <TT> TypeAdapterFactory newFactoryForMultipleTypes(Class<TT> base, final Class<? extends TT> sub, final TypeAdapter<? super TT> typeAdapter)
  {
    new TypeAdapterFactory()
    {
      ...
      {
        Class<? super T> rawType = typeToken.getRawType();
        return (rawType == TypeAdapters.this) || (rawType == sub) ? typeAdapter : null;
      }
      
      public String toString()
      {
        return 
          "Factory[type=" + TypeAdapters.this.getName() + "+" + sub.getName() + ",adapter=" + typeAdapter + "]";
      }
    };
  }
  ...
  public static <TT> TypeAdapterFactory newTypeHierarchyFactory(Class<TT> clazz, final TypeAdapter<TT> typeAdapter)
  {
    new TypeAdapterFactory()
    {
      public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken)
      {
        return TypeAdapters.this.isAssignableFrom(typeToken.getRawType()) ? typeAdapter : null;
      }
      
      public String toString()
      {
        return "Factory[typeHierarchy=" + TypeAdapters.this.getName() + ",adapter=" + typeAdapter + "]";
      }
    };
  }
}
