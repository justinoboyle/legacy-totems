...
public class TypeToken<T>
{
  ...
  public boolean isAssignableFrom(Type from)
  {
    ...
    throw buildUnexpectedTypeError(
      this.type, new Class[] { Class.class, ParameterizedType.class, GenericArrayType.class });
  }
  ...
  private static boolean isAssignableFrom(Type from, ParameterizedType to, Map<String, Type> typeVarMap)
  {
    ...
    int i = (arg = clazz.getGenericInterfaces()).length;
    for (TypeVariable[] tParams = 0; tParams < i; tParams++)
    {
      Type itype = arg[tParams];
  ...
  private static AssertionError buildUnexpectedTypeError(Type token, Class<?>... expected)
  {
    ...
    Class[] arrayOfClass;
    int j = (arrayOfClass = expected).length;
    for (int i = 0; i < j; i++)
    {
