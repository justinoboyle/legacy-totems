    ...
    implements TypeAdapterFactory
  {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type)
    {
      boolean matches = this.exactType != null ? 
        true : (!this.exactType.equals(type)) && ((!this.matchRawType) || (this.exactType.getType() != type.getRawType())) ? false : 
        this.hierarchyType.isAssignableFrom(type.getRawType());
      return matches ? 
        new TreeTypeAdapter(this.serializer, 
        this.deserializer, gson, type, this, null) : 
        null;
    }
  }
}
